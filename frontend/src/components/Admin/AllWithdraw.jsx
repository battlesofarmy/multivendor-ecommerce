...
const AllWithdraw = () => {
  ...
  const [data, setData] = useState([
    {
      _id: "wd001",
      seller: { _id: "shop001", name: "Elegant Shop" },
      amount: 500,
      status: "Processing",
    ...
    {
      _id: "wd002",
      seller: { _id: "shop002", name: "TechHub" },
      amount: 1200,
      status: "Succeed",
    ...
    {
      _id: "wd003",
      seller: { _id: "shop003", name: "StyleSpot" },
      amount: 300,
      status: "Processing",
  ...
  const columns = [
    ...
    { field: "status", headerName: "Status", minWidth: 100, flex: 0.6 },
